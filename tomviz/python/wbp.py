...
#Based on Matlab and scikit's iradon function
#
#Yi Jiang
...
def wbp3(input,angles,N=None,filter="ramp",interp="linaer"):
...
def makeFilter(Nray,filterMethod="ramp"):
    filter_methods = ('none','ramp','shepp-logan','cosin','hamming','hann')
